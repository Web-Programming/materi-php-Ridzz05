...
<div style="max-width: 500px;">
    ...
    <form action="{{ route('produk.update', $produk->id) }}" method="POST" style="margin-top: 4rem;">
        @csrf
        @method('PUT')
        
        <div class="form-group">
            <label for="name">Product Name</label>
            <input type="text" name="name" id="name" class="form-control" value="{{ $produk->name }}" required autocomplete="off">
        </div>
        ...
        <div style="margin-top: 5rem;">
            <button type="submit" class="btn btn-primary" style="margin-right: 2rem;">Update</button>
